...
import uz.gita.bookapp_slp.databinding.FragmentHostBinding
import uz.gita.bookapp_slp.presentation.ui.adapter.HostViewPagerAdapter
...
class HostFragment : Fragment(R.layout.fragment_host) {
    ...
    private fun rateApp() {
        val packageName = "developer?id=uz.gita.bookapp_slp"    // GITA+Dasturchilar+Akademiyasi" // "details?id=uz.gita.wooden15puzzleapp"
